...
SIGN.test(x = c(rep(1, 10), rep(40, 30)),  md = 20)

# autism medication to reduce repetetive behaviors, like programming in R too much
aut <- fread('/home/nate/Dropbox/MSDS/MSDS660_ncg_F8W1_17/week7/autism_medication.csv')
View(aut)
...
placebo <- fread('/home/nate/Dropbox/MSDS/MSDS660_ncg_F8W1_17/week7/placebo_new_drug.csv')
View(placebo)
...
alb <- fread('/home/nate/Dropbox/MSDS/MSDS660_ncg_F8W1_17/week7/albumin.csv')
View(alb)
str(alb)
